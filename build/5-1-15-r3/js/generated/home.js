...
(function() {
  ...
  Chat = (function() {
    ...
    Chat.prototype.postfix_by_number = function(num) {
      var last, lastDec, numStr, out;
      numStr = num.toString();
      last = parseInt(numStr.charAt(numStr.length - 1));
      lastDec = parseInt(numStr.substr(numStr.length - 2, 2));
      if (lastDec >= 10 && lastDec < 20) {
        out = 'й';
      } else if (last === 1) {
        out = 'е';
    ...
    Chat.prototype.add_messages = function(messages) {
      ...
      for (_i = 0, _len = messages.length; _i < _len; _i++) {
        ...
        if (item.hidden) {
          ...
          first_hidden.append($('<span>').addClass('hidden-count').append($('<span>').text('Скрыто ' + last_hidden_count + ' сообщени' + this.postfix_by_number(last_hidden_count))));
          last_hidden_count = 0;
          first_hidden = null;
        }
